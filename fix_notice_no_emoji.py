...
<div 
  ...
  role="dialog"
>
  <div class="relative bg-[#0B0F1A]/95 border border-[#38BDF8]/40 shadow-[0_25px_70px_rgba(0,0,0,0.9)] rounded-3xl max-w-2xl w-full flex flex-col overflow-hidden backdrop-blur-2xl animate-fadeIn">
    ...
    <div class="p-5 sm:p-6 pb-3 border-b border-white/10 flex items-start justify-between">
      <div>
        ...
        <h2 class="text-xl sm:text-2xl font-black text-white flex items-center gap-2.5 tracking-tight">
          <svg class="w-5 h-5 text-[#38BDF8]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.2">
    ...
    <div class="p-5 sm:p-6 overflow-y-auto max-h-[60vh] space-y-4 text-xs sm:text-sm text-slate-200 leading-relaxed font-outfit select-text custom-scrollbar">
      ...
      <div class="space-y-2 pt-1">
        <h3 class="font-black text-amber-400 text-sm flex items-center gap-2">
          <svg class="w-4 h-4 text-amber-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
          </svg>
          <span>下单前请注意</span>
        </h3>
        <ul class="space-y-2 pl-0.5 text-slate-300 text-xs">
          <li class="flex items-start gap-2.5">
            <span class="w-4 h-4 rounded-full bg-amber-500/20 text-amber-400 font-mono text-[10px] font-bold flex items-center justify-center shrink-0 border border-amber-500/30">1</span>
            <span>建议注册并登录后购买，方便查询订单、卡密和售后记录。</span>
          </li>
          <li class="flex items-start gap-2.5">
            <span class="w-4 h-4 rounded-full bg-amber-500/20 text-amber-400 font-mono text-[10px] font-bold flex items-center justify-center shrink-0 border border-amber-500/30">2</span>
            <span>下单前请确认商品适用平台、使用期限和账号要求，买错商品可能会很麻烦。</span>
          </li>
          <li class="flex items-start gap-2.5">
            <span class="w-4 h-4 rounded-full bg-amber-500/20 text-amber-400 font-mono text-[10px] font-bold flex items-center justify-center shrink-0 border border-amber-500/30">3</span>
      ...
      <!-- 收到商品后 -->
      <div class="space-y-2">
        <h3 class="font-black text-sky-400 text-sm flex items-center gap-2">
        ...
        <ul class="space-y-2 pl-0.5 text-slate-300 text-xs">
          <li class="flex items-start gap-2.5">
            <span class="w-4 h-4 rounded-full bg-sky-500/20 text-sky-400 font-mono text-[10px] font-bold flex items-center justify-center shrink-0 border border-sky-500/30">1</span>
            <span>请第一时间保存卡密、兑换码或订单信息。</span>
          </li>
          <li class="flex items-start gap-2.5">
            <span class="w-4 h-4 rounded-full bg-sky-500/20 text-sky-400 font-mono text-[10px] font-bold flex items-center justify-center shrink-0 border border-sky-500/30">2</span>
            <span>请先阅读商品说明，再进行登录、兑换或使用。</span>
          </li>
          <li class="flex items-start gap-2.5">
            <span class="w-4 h-4 rounded-full bg-sky-500/20 text-sky-400 font-mono text-[10px] font-bold flex items-center justify-center shrink-0 border border-sky-500/30">3</span>
            <span>涉及账号类商品时，请不要公开账号、密码和验证码。</span>
          </li>
          <li class="flex items-start gap-2.5">
            <span class="w-4 h-4 rounded-full bg-sky-500/20 text-sky-400 font-mono text-[10px] font-bold flex items-center justify-center shrink-0 border border-sky-500/30">4</span>
      ...
      <!-- 关于代理 -->
      <div class="space-y-2">
        <h3 class="font-black text-emerald-400 text-sm flex items-center gap-2">
      ...
      <!-- 福利 -->
      <div class="flex items-center justify-center gap-2 py-2.5 px-4 text-xs font-bold text-[#38BDF8] bg-[#0284C7]/15 rounded-xl border border-[#38BDF8]/30">
        ...
        <span>关注博主推特，后续将持续发放专属特权与福利</span>
      </div>
    </div>
